<template>
  <article class="rounded-lg bg-white py-6 text-base dark:bg-gray-900">
    ...
    <div class="mt-4 flex items-center space-x-4" v-if="false">
      <button
        type="button"
...
const { user, createdAt } = defineProps(["user", "createdAt"]);
</script>
